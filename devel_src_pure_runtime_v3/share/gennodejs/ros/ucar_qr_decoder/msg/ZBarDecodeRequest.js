...
class ZBarDecodeRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ZBarDecodeRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ZBarDecodeRequest(null);
...
ZBarDecodeRequest.Constants = {
  MODE_RAW_ONLY: 0,
  MODE_ENHANCED_ONLY: 1,
}

module.exports = ZBarDecodeRequest;
