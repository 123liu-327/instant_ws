...
echo "[INFO] Dual-stage v3: real parking/TTS -> planner transfer -> simulation-target parking -> Gazebo trigger"
cleanup_before_start

set +e
FLOW_STARTED=1
rosrun iden_controller xunfei2026_launch_anchor_coverage_parking_lock_v2.py "$@" 2>&1 \
