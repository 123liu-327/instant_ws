...
echo "[INFO] 3-point dual-stage v1: d1/d2/d3 + real/sim parking + handoff"
cleanup_before_start

set +e
FLOW_STARTED=1
rosrun iden_controller xunfei2026_launch_3point_dual_stage_v1.py "$@" 2>&1 \
