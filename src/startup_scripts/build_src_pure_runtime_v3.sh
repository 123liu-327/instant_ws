...
required=(
  ...
  "$DEVEL/lib/flow_end/yellow_line_detector"
  "$DEVEL/lib/line_follower/line_follower_node"
  ...
  "$DEVEL/lib/ucar_qr_decoder/zbar_decoder_node"
  "$DEVEL/lib/ucar_qr_decoder/qr_decoder_node.py"
)
