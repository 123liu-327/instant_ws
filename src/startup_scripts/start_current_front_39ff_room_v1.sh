...
required_files=(
  "$SOURCE_ROOT/ucar_2026_competition/launch/full_competition_current_front_39ff_room_v1.launch"
...
if [[ "$DRY_RUN_VALUE" == "1" ]]; then
  ...
  roslaunch --nodes ucar_2026_competition \
    full_competition_current_front_39ff_room_v1.launch \
...
set +e
roslaunch ucar_2026_competition full_competition_current_front_39ff_room_v1.launch \
  enable_simulation:="$ENABLE_SIMULATION_VALUE" \
  sim_bridge_host:="$SIM_BRIDGE_HOST_VALUE" \
