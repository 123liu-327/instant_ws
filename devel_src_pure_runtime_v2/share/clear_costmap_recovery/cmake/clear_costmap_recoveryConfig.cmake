...
if("TRUE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/ucar/instant_ws/src_pure_runtime_ws/src/clear_costmap_recovery)
  set(clear_costmap_recovery_DEVEL_PREFIX /home/ucar/instant_ws/devel_src_pure_runtime_v2)
  ...
  set(clear_costmap_recovery_INSTALL_PREFIX /home/ucar/instant_ws/src_pure_runtime_ws/install)
...
if(NOT "/home/ucar/instant_ws/src_pure_runtime_ws/src/clear_costmap_recovery/include " STREQUAL " ")
  set(clear_costmap_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/ucar/instant_ws/src_pure_runtime_ws/src/clear_costmap_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ucar/instant_ws/src_pure_runtime_ws/src/clear_costmap_recovery/${idir}'.  ${_report}")
    endif()
