...
echo_and_run cd "/home/ucar/instant_ws/src_pure_runtime_ws_v3/src/tf2_geometry_msgs"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ucar/instant_ws/src_pure_runtime_ws_v3/src/tf2_geometry_msgs/setup.py" \
     \
    build --build-base "/home/ucar/instant_ws/build_src_pure_runtime_v3/tf2_geometry_msgs" \
    install \
    --root="${DESTDIR-/}" \
