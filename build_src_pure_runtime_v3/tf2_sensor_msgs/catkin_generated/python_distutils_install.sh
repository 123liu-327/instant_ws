...
echo_and_run cd "/home/ucar/instant_ws/src_pure_runtime_ws_v3/src/tf2_sensor_msgs"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ucar/instant_ws/src_pure_runtime_ws_v3/src/tf2_sensor_msgs/setup.py" \
     \
    build --build-base "/home/ucar/instant_ws/build_src_pure_runtime_v3/tf2_sensor_msgs" \
    install \
    --root="${DESTDIR-/}" \
